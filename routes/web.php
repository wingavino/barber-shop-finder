...
Route::middleware('isAdmin')->group(function(){
  ...
  Route::get('/admin/shop/settings', [App\Http\Controllers\ShopController::class, 'showShopSettings'])->name('admin.shop.settings'); //Shows Shop's Settings Page for Shopowner
