                          ...
                          @isset($employees)
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                <button class="btn btn-danger col-md-4" data-toggle="modal" data-target="#deleteModal" data-form-action="{{ route('shopowner.shop.employees.add', ['id' => $employee->id]) }}" data-id="{{ $employee->id }}" data-name="{{ $employee->name }}">Delete</button>
                              </td>
                            </tr>
                            @endforeach
                          @endisset
