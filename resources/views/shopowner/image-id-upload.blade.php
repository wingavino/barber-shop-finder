            ...
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="container mt-5">
                    <p class="text-center mb-5">Please upload one valid government-issued ID. <br> The ID should be fully visible in the picture and text should not be blurry.</p>
                    <form action="{{ route('shopowner.img.id') }}" method="post" enctype="multipart/form-data">
                        @csrf
