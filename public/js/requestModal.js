$(document).ready(function(){
  $('#requestModal').on('show.bs.modal', function (event) {
    ...
    if (modal_information.request_type == 'report-review') {
      ...
      modal.find('.modal-body #name').empty();
      modal.find('.modal-body #name').append('<li class="list-group-item"><b>Reported By ID:</b> ' + modal_information.user_id + '</li> <li class="list-group-item"><b>Reported By Name:</b> ' + modal_information.name + '</li> <li class="list-group-item"><b>User ID:</b> ' + modal_information.reported_user_id + '</li> <li class="list-group-item"><b>User Name:</b> '+ modal_information.reported_user_name + '</li> <li class="list-group-item"><b>Email:</b> ' + modal_information.reported_user_email + '</li> <li class="list-group-item"><b>User Type:</b> ' + modal_information.reported_user_type + '</li> <li class="list-group-item"><b>Shop ID:</b> ' + modal_information.shop_id + '</li> <li class="list-group-item"><b>Shop Name:</b> <a href="'+ modal_information['shop_url'] +'" target="_blank">' + modal_information.shop_name + '</a></li> <li class="list-group-item"><b>Report Reason:</b> '+ modal_information.report_reason + '</li> <li class="list-group-item"><b>Review Text:</b> '
